...
export default function Page() {
  return (
    <div className="mx-auto max-w-web-max w-mobile-max py-12 overflow-hidden">
      ...
      >
        ...
        <div className="bg-white min-h-[495px] grid gap-4 place-items-center text-center p-8 rounded-3xl font-cairo z-30">
          ...
          <p className="text-chocolate-brown text-base md:text-2xl font-cairo max-w-[465px]">
            We’ve also put together a few gift ideas on our Wedding Registry,
            filled with thoughtful items to help us settle into our new life
            together.
          </p>
