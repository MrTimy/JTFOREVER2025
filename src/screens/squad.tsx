...
const squadMembers = [
  ...
  },
  {
    ...
    image: Nnamdi,
    content:
      "Your love, support, and friendship mean the world. You've helped carry laughter, calm nerves, and shared unforgettable memories.",
  },
  {
    name: "Wemimo",
    gender: "female",
